...
| 模型 | 提示词 |
|------|--------|
| Codex | `/Users/shaggarw/.claude/.ccg/prompts/codex/tester.md` |
| Gemini | `/Users/shaggarw/.claude/.ccg/prompts/gemini/tester.md` |
...
- **后端代码** → `Bash({ command: "...--backend codex...", run_in_background: false })`
  - ROLE_FILE: `/Users/shaggarw/.claude/.ccg/prompts/codex/tester.md`
- **前端代码** → `Bash({ command: "...--backend gemini...", run_in_background: false })`
  - ROLE_FILE: `/Users/shaggarw/.claude/.ccg/prompts/gemini/tester.md`
- **全栈代码** → 并行调用两者：
